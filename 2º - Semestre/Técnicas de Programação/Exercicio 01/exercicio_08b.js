...
function comparacao(stpontuacao){
    let pontuacoes = stpontuacao.split(' ') /*Split separa a string conforme dado informado ()*/
    let qtdQuebraRecords = 0
    let piorjogo = 1
    let maiorponto = pontuacoes[0]
    let menorponto = pontuacoes[0]

    for(let i = 1; i < pontuacoes.length; i++){ // lenght faz a contagem da lista
...
console.log(comparacao("10 20 20 8 25 3 0 30 1"))
